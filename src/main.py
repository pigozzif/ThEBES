...
def parse_args():
    ...
    parser.add_argument("--center-lr", type=float, default=0.05, help="Center learning rate.")
    parser.add_argument("--std-lr", type=float, default=0.1, help="Std learning rate.")
