...
from .factory import GenotypeFactory
from ..evolution.objectives import ObjectiveDict
from ..utils.utilities import dominates
...
class Population(object):
    ...
    def __init__(self, pop_size: int, genotype_factory: GenotypeFactory, objectives_dict: ObjectiveDict,
        ...
        self._individuals = []
        self._max_id = 0
        for g in self.init_random_individuals(n=pop_size):
    ...
    def init_random_individuals(self, n):
        return self.genotype_factory.create_population(pop_size=n)
